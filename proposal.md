...
## Description
- A basic and small adventure game where the player just explores that map. Talking to NPCs and doing small quests. There is no plan for a final goal of any sort.
## Need to Have
- Proper Movement system that can detect collisions.
- Dialouge Box System
